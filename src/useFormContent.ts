const useFormContent = (content: Array<any>, { toReversePolishNotation, computeReversePolishNotation }: any) => {
     ...
     * @returns 
     */
    const handleNormalObject = (item: { [x: string]: any; }) => {
      const newItem: any = {};
     ...
     * @param valueObject 
     */
    const handleValueObject = (valueObject: { value: any; expression: any; }) => {
    ...
    const handleExpression = (expression: any) => {
      // console.log(expression);
